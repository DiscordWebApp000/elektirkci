  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-black border-b border-gray-800">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-40" style={{ backgroundImage: 'url(/img/sayfa1.jpg)' }}></div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <article className="mb-16">
          <div className="max-w-3xl mx-auto">
            <div 
              className="news-content prose prose-gray prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-li:text-gray-700 prose-strong:text-gray-900 prose-a:text-amber-600 prose-a:no-underline hover:prose-a:underline"
